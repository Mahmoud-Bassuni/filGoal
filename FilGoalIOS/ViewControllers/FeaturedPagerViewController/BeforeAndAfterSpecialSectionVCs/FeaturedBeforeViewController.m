//
//  FeaturedBeforeViewController.m
//  Reyada
//
...
@import Firebase;
@interface FeaturedBeforeViewController ()

@end

@implementation FeaturedBeforeViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view from its nib.
    self.screenName=[NSString stringWithFormat:@"iOS-SpecialSection-Before-%@",self.title];
    [FIRAnalytics logEventWithName:kFIREventViewItem
                        parameters:@{
                                     kFIRParameterItemName:[NSString stringWithFormat:@"iOS-SpecialSection-Before-%@",self.title]
                                     }];
}
