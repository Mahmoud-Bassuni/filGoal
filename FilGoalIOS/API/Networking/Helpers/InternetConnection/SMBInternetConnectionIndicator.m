...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        indicatorLabel.font                             = [UIFont fontWithName:@"DINNextLTW23Regular" size:12];
        indicatorLabel.textColor                        = [UIColor whiteColor];
        indicatorLabel.textAlignment                    = NSTextAlignmentCenter;
        indicatorLabel.text                             = @"عفوًا لا يوجد اتصال بشبكة الإنترنت";
        ...
        NSString *remoteHostName = @"filgoal.com";
