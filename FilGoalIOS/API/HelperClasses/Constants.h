...
static NSString *  kPredictCrednitialIdentifier=@"Predict";
...
#define Test_AD_UNIT_ID @"/7524/Test-Mobile-App/Test-04"
#define MPU_AD_UNIT_ID @"/7524/Test-Mobile-App/Test-03"
...
//static NSString * AppInfo_URL = @"http://api.filgoal.com/MobileAppResources/iOS/test.json";
//static NSString * AppInfo_URL = @"http://api.jsonbin.io/b/5b1a1e16c83f6d4cc734ace4";
