...
- (CGSize)calculateTitleSizeWithString:(NSString *)string
{
    ...
    NSDictionary *dic = @{NSFontAttributeName: [UIFont fontWithName:@"DINNextLTW23Regular" size:fontSize]};
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.font =  [UIFont fontWithName:@"DINNextLTW23Regular" size:14];
