...
#define SHKFacebookKey				@"398918790193954"
#define SHKFacebookSecret			@"66cbd92be8241e079418fb177a19f873"
 ...
 */
#define SHKTwitterConsumerKey		@"sQRKDyXhwb2Uh1KhTdQZg"
#define SHKTwitterSecret			@"9xKwqjijsPCrQn0SSzr2M4Qsiv3YnataE3DruBgSw"
#define SHKTwitterCallbackUrl		@"http://www.filgoal.com/Arabic/Default.aspx" // You need to set this if using OAuth, see note above (xAuth users can skip it)
