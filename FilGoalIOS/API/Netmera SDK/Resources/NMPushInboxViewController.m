...
{
    if (!_selectAllItem) {
        _selectAllItem = [[UIBarButtonItem alloc] initWithTitle:NMLocalizedString(@"select_all_btn",@"Select All") style:UIBarButtonItemStylePlain target:self action:@selector(selectAllNotifications)];
    }
...
{
    if (!_deselectAllItem) {
        _deselectAllItem = [[UIBarButtonItem alloc] initWithTitle:NMLocalizedString(@"deselect_all_btn",@"Deselect All") style:UIBarButtonItemStylePlain target:self action:@selector(deselectAllNotifications)];
    }
...
{
    if (!_closeItem) {
        _closeItem = [[UIBarButtonItem alloc] initWithTitle:NMLocalizedString(@"close_btn", @"Close") style:UIBarButtonItemStylePlain target:self action:@selector(closeButtonTouched)];
    }
...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *item = [[UIBarButtonItem alloc] initWithTitle:NMLocalizedString(@"delete_btn", @"Delete") style:UIBarButtonItemStylePlain target:self action:@selector(deleteButtonTouched)];

    UIBarButtonItem *markReadItem = [[UIBarButtonItem alloc] initWithTitle:NMLocalizedString(@"mark_as_read_btn", @"Mark as Read") style:UIBarButtonItemStylePlain target:self action:@selector(readButtonTouched)];
    UIBarButtonItem *markUnreadItem = [[UIBarButtonItem alloc] initWithTitle:NMLocalizedString(@"mark_as_unread_btn", @"Mark as Unread") style:UIBarButtonItemStylePlain target:self action:@selector(unreadButtonTouched)];
