...
- (void)webViewDidFinishLoad:(HUMDisqusWebView *)webView {
    ...
    NSLog(@"%@",html);
    //self.webView.scrollView setContentSize:(self.webView.scrollView.contentSize.width,self.webView.scrollView.contentSize.height-100);
   // [self.webView sizeToFit];
    //self.webView.scrollView.contentSize=CGSizeMake(self.webView.scrollView.contentSize.width, self.webView.scrollView.contentSize.height-3*Screenheight);
