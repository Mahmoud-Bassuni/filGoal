  ...
  overrideLineWidth:(NSNumber *)overrideLineWidth
{
    ...
    if (self) {
        ...
        _circleBackground.strokeColor = (hasBackgroundShadow ? backgroundShadowColor.CGColor : [UIColor colorWithRed:0.94 green:0.94 blue:0.94 alpha:1.0].CGColor);
