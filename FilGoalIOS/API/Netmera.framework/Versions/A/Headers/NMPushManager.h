...
/**
 * Whether SDK should automatically register to remote notifications or not.
 *
 * In order to stop automatic registration, you should implement this method and return NO.
 * If not implemented, or returns YES, SDK will register automatically after 
 * -application:didFinishLaunchingWithOptions: method is done.
 */
- (BOOL)shouldRegisterToPushNotificationsAutomatically;
...
/**
 * Calls +setEnabledUserNotificationTypes:categories: method with given categories and 
 * (UIUserNotificationTypeAlert | UIUserNotificationTypeBadge | UIUserNotificationTypeSound) as `types` argument.
 *
...
/**
 * Calls +setEnabledUserNotificationTypes:categories: method with given types and nil `categories` argument
 *
 *  @param types A UIUserNotificationType enum.
 */
+ (void)setEnabledUserNotificationTypes:(UIUserNotificationType)types;

/**
 * Registers device to push notifications by enabling given types and UIUserNotificationCategory set.
 *
 * This method internally creates a UIUserNotificationSettings object having given categories and types, 
 * and registers the device using UIApplication's -registerUserNotificationSettings: method.
 *
 *  @param types A UIUserNotificationType enum.
 *  @param categories The set containing UIUserNotificationCategory objects.
 *
 */
+ (void)setEnabledUserNotificationTypes:(UIUserNotificationType)types categories:(NSSet *)categories;
